...
#### Click on the photo to open the Photo Gallery
...
#### Rotation <img src="/media/media_3abcbf294c5f55f7.png" width="58" height="37" />

#### Delete <img src="/media/media_7e7520483684c77e.png" width="21" height="29" />

#### Select for an action <img src="/media/media_db5565f08fd0257d.png" width="66" height="28" />
...
Next steps of the exporting process are identical to process steps described above (“Export all to PDF”).
...
### Map view
Points that represent photos or tasks displayed on the currently open page are always displayed on the map.
...
#### Zoom
* zoom of the map is automatically set so that all points are visible
in the displayed area of the map
* zoom can be adjusted manually (with the mouse wheel or using the control panel on the map).</br>

#### Coded markers
* points are color <b>*coded*</b> according to the active status of the task. 
* Color of the points corresponds to the color of the status in the task list.

Points representing unassigned photos are not <b>*color coded*</b>.
...
* High concentration of points in a small area, the points are grouped into one group with a numerical expression of the
number of points.
* Click on the group icon to zoom in on the group position. As you zoom in greatly on the map 
    * points are changed to preview banners that display :
        * specific user
        * name of the task
        * photo and the radius of the camera view at the time the photo was taken.

* Clicking on this banner opens the following task detail.
...
After logging in, the user management page is displayed.

* Graphically and functionally, the application is the same as in the approach for users.

* Administrator access, controls are added as described below.
...
<br>The creation of a new task is confirmed by pressing the Save button.

* A new task is created with the status"*new*"
...
<img src="/media/media_purpose-add-new.png" width="142" height="45" />

* Clicking on the button displays a
table in which it is necessary to fill in the data of the new purpose.
<br>The creation of a new purpose is confirmed by pressing the Save button.

<img src="/media/media_purpose-add-new-table.png" width="320" height="214" />

#### Edit an existing purpose

* Clicking on the button displays a
table in which it is necessary to fill in the data of the edit purpose.
<br>Edit purpose property is confirmed by pressing the Save button.

<img src="/media/media_purpose-edit-table.png" width="320" height="214" />

#### Deactivate an existing purpose
