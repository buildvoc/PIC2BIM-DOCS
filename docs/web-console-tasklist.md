...
#### 2.1.1 Open task detail actions
...
#### 2.2.4 PDF export functionality
...
#### 4.1.0 Highlighted path with point detail
- [ ] Highlighted path with point detail
...
#### 4.1.1 Generating PDF documents actions
...
#### 5.1.0 Map active status markers
- [ ] new
- [ ] open
- [ ] data provided
- [ ] data checked (green)
- [ ] data checked (red)
- [ ] returned
- [ ] unassigned photos are not color* coded.

<img src="/media/media_7fe4e6af989321c9.png" width="605" height="39" />

Fig. 44 Task status list

#### 5.1.1 Map middle zoom
- [ ] middle zoom
- [ ] grouped into one group with a numerical expression
- [ ] Click on the group icon to zoom in on
the group position
- [ ] preview banners that display a specific user
- [ ] the name of the
task, the photo and 
- [ ] the radius of the camera view at the time the photo was taken.
